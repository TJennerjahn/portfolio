...
4. Hit the prepare icon in the menu bar:
   ...
   ![Prepare a device in Apple Configurator](/blog-images/apple-mdm-prepare-device.png)

5. Select Manual Configuration.

   ![Select manual configuration in Apple Configurator](/blog-images/apple-mdm-manual-configuration.png)
...
8. Then when it asks you to type in a phone numer or email, just hit skip. This is important!
   ...
   ![Skip the phone number or email step in Apple Configurator](/blog-images/apple-mdm-skip-contact-step.png)
...
9. It will now ask you create an org. Just type in a name, then select Generate a new identity, at which point you'll be asked to configure the ios setup assistant. Just keep everything the way it is and press Prepare.
   ...
   ![Create a new organization identity in Apple Configurator](/blog-images/apple-mdm-create-organization.png)
...
![Apple Configurator restrictions settings](/blog-images/apple-mdm-restrictions.png)
...
![Blocked apps in Apple Configurator](/blog-images/apple-mdm-blocked-apps.png)
