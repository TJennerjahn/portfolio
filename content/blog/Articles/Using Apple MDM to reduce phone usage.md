...
aliases:
  - Using Apple MDM to reduce phone usage
---
...
4. Hit the prepare icon in the menu bar:

   ![Prepare a device in Apple Configurator](../Attachments/apple-mdm-prepare-device.png)

5. Select Manual Configuration.

   ![Select manual configuration in Apple Configurator](../Attachments/apple-mdm-manual-configuration.png)

6. For your MDM Server, select *"Do not enroll in MDM"*
7. Organization: *"New Organization"*
8. Then when it asks you to type in a phone numer or email, just hit skip. This is important!

   ![Skip the phone number or email step in Apple Configurator](../Attachments/apple-mdm-skip-contact-step.png)

9. It will now ask you create an org. Just type in a name, then select Generate a new identity, at which point you'll be asked to configure the ios setup assistant. Just keep everything the way it is and press Prepare.

   ![Create a new organization identity in Apple Configurator](../Attachments/apple-mdm-create-organization.png)
...
![Apple Configurator restrictions settings](../Attachments/apple-mdm-restrictions.png)
...
![Blocked apps in Apple Configurator](../Attachments/apple-mdm-blocked-apps.png)
